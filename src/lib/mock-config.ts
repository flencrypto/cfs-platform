...
export const mockData = {
  ...
  sports: [
    { id: "soccer", name: "Soccer", slug: "soccer", displayName: "Soccer", isActive: true },
    { id: "nba", name: "NBA", slug: "nba", displayName: "NBA", isActive: true },
    { id: "nfl", name: "NFL", slug: "nfl", displayName: "NFL", isActive: true },
    { id: "ufc", name: "UFC", slug: "ufc", displayName: "UFC", isActive: true },
  ],
  users: [
    {
      id: "user_1",
